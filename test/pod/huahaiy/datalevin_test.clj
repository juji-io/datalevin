...
#_(deftest with-transaction-kv-test
...
#_(deftest with-txn-kv-map-resize-test
    (let [dir  (u/tmp-dir (str "pod-with-tx-kv-test-" (UUID/randomUUID)))
...
#_(deftest with-transaction-test
...
#_(deftest with-txn-map-resize-test
   (let [dir    (u/tmp-dir (str "pod-with-tx-test-" (UUID/randomUUID)))
