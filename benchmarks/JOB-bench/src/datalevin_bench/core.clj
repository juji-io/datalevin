...
;; => {:planning-time "3077.198 ms", :actual-result-size 1, :execution-time "65200.315 ms", :opt-clauses [[?ci :cast-info/note ?ci.note] [?cn :company-name/country-code "[us]"] [?t :title/production-year ?t.production-year] [?mc :movie-companies/movie ?t] [?ci :cast-info/movie ?t] [?ci :cast-info/person-role ?chn] [?mc :movie-companies/company ?cn] [?chn :char-name/name ?chn.name] [?t :title/title ?t.title] [(like ?ci.note "%(producer)%")] [(< 1990 ?t.production-year)]], :query-graph {$ {?ci {:links [{:type :ref, :tgt ?t, :attr :cast-info/movie} {:type :ref, :tgt ?chn, :attr :cast-info/person-role} {:type :val-eq, :tgt ?mc, :var ?t, :attrs {?ci :cast-info/movie, ?mc :movie-companies/movie}}], :mpath [:free :cast-info/note], :mcount 14237092, :free #:cast-info{:note {:var ?ci.note, :count 14237092, :pred #function[datalevin.query/activate-pred/pred--40566]}, :movie {:var ?t, :count 36244344}, :person-role {:var ?chn, :count 17571519}}}, ?cn {:links [{:type :_ref, :tgt ?mc, :attr :movie-companies/company}], :mpath [:bound :company-name/country-code], :mcount 84843, :bound #:company-name{:country-code {:val "[us]", :count 84843}}}, ?t {:links [{:type :_ref, :tgt ?ci, :attr :cast-info/movie} {:type :_ref, :tgt ?mc, :attr :movie-companies/movie}], :mpath [:free :title/production-year], :mcount 1772072, :free #:title{:production-year {:var ?t.production-year, :range [[[:open 1990] [:closed :db.value/sysMax]]], :count 1772072}, :title {:var ?t.title, :count 2528312}}}, ?mc {:links [{:type :ref, :tgt ?t, :attr :movie-companies/movie} {:type :ref, :tgt ?cn, :attr :movie-companies/company} {:type :val-eq, :tgt ?ci, :var ?t, :attrs {?ci :cast-info/movie, ?mc :movie-companies/movie}}], :mpath [:free :movie-companies/movie], :mcount 2609129, :free #:movie-companies{:movie {:var ?t, :count 2609129}, :company {:var ?cn, :count 2609129}}}, ?chn {:links [{:type :_ref, :tgt ?ci, :attr :cast-info/person-role}], :mpath [:free :char-name/name], :mcount 3140339, :free #:char-name{:name {:var ?chn.name, :count 3140339}}}}}, :plan {$ [(#datalevin.query.Plan{:steps ["Initialize [?mc ?t] by :movie-companies/movie." "Merge [?cn] by scanning [:movie-companies/company]."], :cost 7827387, :size 2609129, :actual-size 2609129} #datalevin.query.Plan{:steps ["Merge ?ci by equal values  of :cast-info/movie." "Merge [?chn ?ci.note] by scanning [:cast-info/person-role :cast-info/note]."], :cost 8266161, :size 62682, :actual-size 31} #datalevin.query.Plan{:steps ["Merge ?ci by reverse reference  of :cast-info/person-role." "Filter by predicates on [:cast-info/movie :cast-info/note]."], :cost 8269258, :size 163, :actual-size 31} #datalevin.query.Plan{:steps ["Filter by predicates on [:company-name/country-code]."], :cost 8269747, :size 163, :actual-size 14} #datalevin.query.Plan{:steps ["Merge ?ci by reverse reference  of :cast-info/movie." "Filter by predicates on [:cast-info/person-role :cast-info/note]."], :cost 8269804, :size 3, :actual-size 14})]}, :late-clauses (), :result ([nil nil])}
