...
(d/explain {:run? false} q-1a (d/db conn));; => {:planning-time "11.010 ms", :opt-clauses [[?ct :company-type/kind "production companies"] [?it :info-type/info "top 250 rank"] [?mc :movie-companies/note ?mc.note] [?mc :movie-companies/company-type ?ct] [?mc :movie-companies/movie ?t] [?mi :movie-info-idx/movie ?t] [?mi :movie-info-idx/info-type ?it] [?t :title/title ?t.title] [?t :title/production-year ?t.production-year] [(not-like ?mc.note "%(as Metro-Goldwyn-Mayer Pictures)%")]], :query-graph {$ {?ct {:links [{:type :_ref, :tgt ?mc, :attr :movie-companies/company-type}], :mpath [:bound :company-type/kind], :mcount 1, :bound #:company-type{:kind {:val "production companies", :count 1}}}, ?it {:links [{:type :_ref, :tgt ?mi, :attr :movie-info-idx/info-type}], :mpath [:bound :info-type/info], :mcount 1, :bound #:info-type{:info {:val "top 250 rank", :count 1}}}, ?mc {:links [{:type :ref, :tgt ?ct, :attr :movie-companies/company-type} {:type :ref, :tgt ?t, :attr :movie-companies/movie} {:type :val-eq, :tgt ?mi, :var ?t, :attrs {?mc :movie-companies/movie, ?mi :movie-info-idx/movie}}], :mpath [:free :movie-companies/note], :mcount 267428, :free #:movie-companies{:note {:var ?mc.note, :count 267428, :pred [#function[datalevin.query/optimize-like/fn--27572]]}, :company-type {:var ?ct, :count 1274246}, :movie {:var ?t, :count 267431}}}, ?mi {:links [{:type :ref, :tgt ?t, :attr :movie-info-idx/movie} {:type :ref, :tgt ?it, :attr :movie-info-idx/info-type} {:type :val-eq, :tgt ?mc, :var ?t, :attrs {?mc :movie-companies/movie, ?mi :movie-info-idx/movie}}], :mpath [:free :movie-info-idx/movie], :mcount 1380035, :free #:movie-info-idx{:movie {:var ?t, :count 1380035}, :info-type {:var ?it, :count 1380035}}}, ?t {:links [{:type :_ref, :tgt ?mc, :attr :movie-companies/movie} {:type :_ref, :tgt ?mi, :attr :movie-info-idx/movie}], :mpath [:free :title/production-year], :mcount 2456218, :free #:title{:title {:var ?t.title, :count 2528312}, :production-year {:var ?t.production-year, :count 2456218}}}}}, :plan {$ [(#datalevin.query.Plan{:steps ["Initialize [?it] by :info-type/info = top 250 rank."], :cost 1, :size 1} #datalevin.query.Plan{:steps ["Merge ?mi by scanning reverse reference of :movie-info-idx/info-type." "Merge [?t] by scanning [:movie-info-idx/movie]."], :cost 552015, :size 276007} #datalevin.query.Plan{:steps ["Merge ?mc by equal values of :movie-companies/movie." "Merge [?mc.note ?ct] by scanning [:movie-companies/note :movie-companies/company-type]."], :cost 1027245, :size 67890} #datalevin.query.Plan{:steps ["Merge [] by scanning [:company-type/kind]."], :cost 1230915, :size 67890} #datalevin.query.Plan{:steps ["Merge [?t.title ?t.production-year] by scanning [:title/title :title/production-year]."], :cost 1366695, :size 67890})]}, :late-clauses ([(or (like ?mc.note "%(co-production)%") (like ?mc.note "%(presents)%"))])}
