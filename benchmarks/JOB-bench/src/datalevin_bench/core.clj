...
;; => {:planning-time "233.181", :actual-result-size 0, :execution-time "3669.743", :opt-clauses [[?cn :company-name/country-code "[us]"] [?it1 :info-type/info "release dates"] [?mi :movie-info/note ?mi.note] [?mi :movie-info/info ?mi.info] [?t :title/production-year ?t.production-year] [?at :aka-title/movie ?t] [?mi :movie-info/movie ?t] [?mk :movie-keyword/movie ?t] [?mc :movie-companies/movie ?t] [?mk :movie-keyword/keyword ?k] [?mi :movie-info/info-type ?it1] [?mc :movie-companies/company ?cn] [?t :title/title ?t.title] [?mc :movie-companies/company-type ?ct] [(like ?mi.note "%internet%")] [(and (like ?mi.info "USA:%") (or (like ?mi.info "% 199%") (like ?mi.info "% 200%")))] [(< 1990 ?t.production-year)]], :query-graph {$ {?cn {:links [{:type :_ref, :tgt ?mc, :attr :movie-companies/company}], :bound [{:attr :company-name/country-code, :val "[us]"}]}, ?it1 {:links [{:type :_ref, :tgt ?mi, :attr :movie-info/info-type}], :bound [{:attr :info-type/info, :val "release dates"}]}, ?mi {:links [{:type :ref, :tgt ?t, :attr :movie-info/movie} {:type :ref, :tgt ?it1, :attr :movie-info/info-type} {:type :val-eq, :tgt ?at, :var ?t, :attrs {?mi :movie-info/movie, ?at :aka-title/movie}} {:type :val-eq, :tgt ?mk, :var ?t, :attrs {?mi :movie-info/movie, ?mk :movie-keyword/movie}} {:type :val-eq, :tgt ?mc, :var ?t, :attrs {?mi :movie-info/movie, ?mc :movie-companies/movie}}], :free [{:attr :movie-info/note, :var ?mi.note, :pred #function[datalevin.query/activate-pred/pred--51508]} {:attr :movie-info/info, :var ?mi.info, :pred #function[datalevin.query/logic-pred/logic-f--51554/logic--51555]} {:attr :movie-info/movie, :var ?t} {:attr :movie-info/info-type, :var ?it1}]}, ?t {:links [{:type :_ref, :tgt ?mi, :attr :movie-info/movie} {:type :_ref, :tgt ?at, :attr :aka-title/movie} {:type :_ref, :tgt ?mk, :attr :movie-keyword/movie} {:type :_ref, :tgt ?mc, :attr :movie-companies/movie}], :free [{:attr :title/production-year, :var ?t.production-year, :range [[[:open 1990] [:closed :db.value/sysMax]]]} {:attr :title/title, :var ?t.title}]}, ?at {:links [{:type :ref, :tgt ?t, :attr :aka-title/movie} {:type :val-eq, :tgt ?mi, :var ?t, :attrs {?mi :movie-info/movie, ?at :aka-title/movie}} {:type :val-eq, :tgt ?mk, :var ?t, :attrs {?at :aka-title/movie, ?mk :movie-keyword/movie}} {:type :val-eq, :tgt ?mc, :var ?t, :attrs {?at :aka-title/movie, ?mc :movie-companies/movie}}], :free [{:attr :aka-title/movie, :var ?t}]}, ?mk {:links [{:type :ref, :tgt ?t, :attr :movie-keyword/movie} {:type :val-eq, :tgt ?mi, :var ?t, :attrs {?mi :movie-info/movie, ?mk :movie-keyword/movie}} {:type :val-eq, :tgt ?at, :var ?t, :attrs {?at :aka-title/movie, ?mk :movie-keyword/movie}} {:type :val-eq, :tgt ?mc, :var ?t, :attrs {?mk :movie-keyword/movie, ?mc :movie-companies/movie}}], :free [{:attr :movie-keyword/movie, :var ?t} {:attr :movie-keyword/keyword, :var ?k}]}, ?mc {:links [{:type :ref, :tgt ?t, :attr :movie-companies/movie} {:type :ref, :tgt ?cn, :attr :movie-companies/company} {:type :val-eq, :tgt ?mi, :var ?t, :attrs {?mi :movie-info/movie, ?mc :movie-companies/movie}} {:type :val-eq, :tgt ?at, :var ?t, :attrs {?at :aka-title/movie, ?mc :movie-companies/movie}} {:type :val-eq, :tgt ?mk, :var ?t, :attrs {?mk :movie-keyword/movie, ?mc :movie-companies/movie}}], :free [{:attr :movie-companies/movie, :var ?t} {:attr :movie-companies/company, :var ?cn} {:attr :movie-companies/company-type, :var ?ct}]}}}, :plan {$ [(#datalevin.query.Plan{:steps ["Initialize [?it1] by :info-type/info = release dates."], :cost 2, :size 1, :actual-size 1} #datalevin.query.Plan{:steps ["Merge ?mi by reverse reference of :movie-info/info-type." "Merge [?mi.note ?mi.info ?t] by scanning [:movie-info/info :movie-info/note :movie-info/info-type :movie-info/movie]."], :cost 40, :size 3034, :actual-size 0} #datalevin.query.Plan{:steps ["Merge ?at by equal values of :aka-title/movie."], :cost 3074, :size 4, :actual-size 0} #datalevin.query.Plan{:steps ["Merge ?mc by equal values of :movie-companies/movie." "Merge [?cn ?ct] by scanning [:movie-companies/company :movie-companies/movie :movie-companies/company-type]."], :cost 3111, :size 1, :actual-size 0} #datalevin.query.Plan{:steps ["Merge [?t.production-year ?t.title] by scanning [:title/title :title/production-year]."], :cost 3117, :size 1, :actual-size 0} #datalevin.query.Plan{:steps ["Filter by predicates on [:company-name/country-code]."], :cost 3121, :size 1, :actual-size 0} #datalevin.query.Plan{:steps ["Merge ?mk by equal values of :movie-keyword/movie." "Merge [?k] by scanning [:movie-keyword/movie :movie-keyword/keyword]."], :cost 3128, :size 15, :actual-size 0})]}, :late-clauses (), :result ()}
