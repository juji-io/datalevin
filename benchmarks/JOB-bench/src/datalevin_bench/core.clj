...
;; => {:planning-time "419.489 ms", :actual-result-size 3, :execution-time "20.979 ms", :opt-clauses [[?ci :cast-info/note ?ci.note] [?cn :company-name/country-code "[us]"] [?cn :company-name/name "DreamWorks Animation"] [?it :info-type/info "release dates"] [?k :keyword/keyword ?k.keyword] [?mi :movie-info/info ?mi.info] [?n :name/gender "f"] [?n :name/name ?n.name] [?rt :role-type/role "actress"] [?t :title/production-year ?t.production-year] [?t :title/title ?t.title] [?mi :movie-info/movie ?t] [?mc :movie-companies/movie ?t] [?ci :cast-info/movie ?t] [?mk :movie-keyword/movie ?t] [?mc :movie-companies/company ?cn] [?mi :movie-info/info-type ?it] [?ci :cast-info/person ?n] [?ci :cast-info/role ?rt] [?an :aka-name/person ?n] [?ci :cast-info/person-role ?chn] [?chn :char-name/name ?chn.name] [?mk :movie-keyword/keyword ?k] [(in ?ci.note ["(voice)" "(voice: Japanese version)" "(voice) (uncredited)" "(voice: English version)"])] [(in ?k.keyword ["hero" "martial-arts" "hand-to-hand-combat" "computer-animated-movie"])] [(and (or (like ?mi.info "Japan:%") (like ?mi.info "USA:%")) (like ?mi.info "%201%"))] [(like ?n.name "%An%")] [(< 2010 ?t.production-year)] [(like ?t.title "Kung Fu Panda%")]], :query-graph {$ {?k {:links [{:type :_ref, :tgt ?mk, :attr :movie-keyword/keyword}], :mpath [:free :keyword/keyword], :mcount 3, :free #:keyword{:keyword {:var ?k.keyword, :range [[[:closed "computer-animated-movie"] [:closed "computer-animated-movie"]] [[:closed "hand-to-hand-combat"] [:closed "hand-to-hand-combat"]] [[:closed "hero"] [:closed "hero"]] [[:closed "martial-arts"] [:closed "martial-arts"]]], :count 3}}}, ?ci {:links [{:type :ref, :tgt ?t, :attr :cast-info/movie} {:type :ref, :tgt ?n, :attr :cast-info/person} {:type :ref, :tgt ?rt, :attr :cast-info/role} {:type :ref, :tgt ?chn, :attr :cast-info/person-role} {:type :val-eq, :tgt ?an, :var ?n, :attrs {?ci :cast-info/person, ?an :aka-name/person}} {:type :val-eq, :tgt ?mi, :var ?t, :attrs {?ci :cast-info/movie, ?mi :movie-info/movie}} {:type :val-eq, :tgt ?mc, :var ?t, :attrs {?ci :cast-info/movie, ?mc :movie-companies/movie}} {:type :val-eq, :tgt ?mk, :var ?t, :attrs {?ci :cast-info/movie, ?mk :movie-keyword/movie}}], :mpath [:free :cast-info/note], :mcount 867477, :free #:cast-info{:note {:var ?ci.note, :range [[[:closed "(voice)"] [:closed "(voice)"]] [[:closed "(voice) (uncredited)"] [:closed "(voice) (uncredited)"]] [[:closed "(voice: English version)"] [:closed "(voice: English version)"]] [[:closed "(voice: Japanese version)"] [:closed "(voice: Japanese version)"]]], :count 867477}, :movie {:var ?t, :count 867518}, :person {:var ?n, :count 867493}, :role {:var ?rt, :count 12670688}, :person-role {:var ?chn, :count 1322872}}}, ?an {:links [{:type :ref, :tgt ?n, :attr :aka-name/person} {:type :val-eq, :tgt ?ci, :var ?n, :attrs {?ci :cast-info/person, ?an :aka-name/person}}], :mpath [:free :aka-name/person], :mcount 901343, :free #:aka-name{:person {:var ?n, :count 901343}}}, ?chn {:links [{:type :_ref, :tgt ?ci, :attr :cast-info/person-role}], :mpath [:free :char-name/name], :mcount 3140339, :free #:char-name{:name {:var ?chn.name, :count 3140339}}}, ?mi {:links [{:type :ref, :tgt ?t, :attr :movie-info/movie} {:type :ref, :tgt ?it, :attr :movie-info/info-type} {:type :val-eq, :tgt ?ci, :var ?t, :attrs {?ci :cast-info/movie, ?mi :movie-info/movie}} {:type :val-eq, :tgt ?mc, :var ?t, :attrs {?mi :movie-info/movie, ?mc :movie-companies/movie}} {:type :val-eq, :tgt ?mk, :var ?t, :attrs {?mi :movie-info/movie, ?mk :movie-keyword/movie}}], :mpath [:free :movie-info/info], :mcount 2967144, :free #:movie-info{:info {:var ?mi.info, :count 2967144, :pred #function[datalevin.query/logic-pred/logic-f--40278/logic--40279]}, :movie {:var ?t, :count 2967148}, :info-type {:var ?it, :count 3624977}}}, ?n #datalevin.query.Node{:links [{:type :_ref, :tgt ?ci, :attr :cast-info/person} {:type :_ref, :tgt ?an, :attr :aka-name/person}], :mpath [:free :name/name], :mcount 192311, :bound #:name{:gender {:val "f", :count 961555}}, :free #:name{:name {:var ?n.name, :count 192311, :pred #function[datalevin.query/activate-pred/pred--40232]}}}, ?rt {:links [{:type :_ref, :tgt ?ci, :attr :cast-info/role}], :mpath [:bound :role-type/role], :mcount 1, :bound #:role-type{:role {:val "actress", :count 1}}}, ?mc {:links [{:type :ref, :tgt ?t, :attr :movie-companies/movie} {:type :ref, :tgt ?cn, :attr :movie-companies/company} {:type :val-eq, :tgt ?ci, :var ?t, :attrs {?ci :cast-info/movie, ?mc :movie-companies/movie}} {:type :val-eq, :tgt ?mi, :var ?t, :attrs {?mi :movie-info/movie, ?mc :movie-companies/movie}} {:type :val-eq, :tgt ?mk, :var ?t, :attrs {?mc :movie-companies/movie, ?mk :movie-keyword/movie}}], :mpath [:free :movie-companies/movie], :mcount 2609129, :free #:movie-companies{:movie {:var ?t, :count 2609129}, :company {:var ?cn, :count 2609129}}}, ?it {:links [{:type :_ref, :tgt ?mi, :attr :movie-info/info-type}], :mpath [:bound :info-type/info], :mcount 1, :bound #:info-type{:info {:val "release dates", :count 1}}}, ?cn {:links [{:type :_ref, :tgt ?mc, :attr :movie-companies/company}], :mpath [:bound :company-name/name], :mcount 1, :bound #:company-name{:country-code {:val "[us]", :count 84843}, :name {:val "DreamWorks Animation", :count 1}}}, ?t {:links [{:type :_ref, :tgt ?ci, :attr :cast-info/movie} {:type :_ref, :tgt ?mi, :attr :movie-info/movie} {:type :_ref, :tgt ?mc, :attr :movie-companies/movie} {:type :_ref, :tgt ?mk, :attr :movie-keyword/movie}], :mpath [:free :title/title], :mcount 3, :free #:title{:production-year {:var ?t.production-year, :range [[[:open 2010] [:closed :db.value/sysMax]]], :count 533369}, :title {:var ?t.title, :range [[[:closed "Kung Fu Panda"] [:closed "Kung Fu Panda����������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������"]]], :count 3, :pred #function[datalevin.query/activate-pred/pred--40232]}}}, ?mk {:links [{:type :ref, :tgt ?t, :attr :movie-keyword/movie} {:type :ref, :tgt ?k, :attr :movie-keyword/keyword} {:type :val-eq, :tgt ?ci, :var ?t, :attrs {?ci :cast-info/movie, ?mk :movie-keyword/movie}} {:type :val-eq, :tgt ?mi, :var ?t, :attrs {?mi :movie-info/movie, ?mk :movie-keyword/movie}} {:type :val-eq, :tgt ?mc, :var ?t, :attrs {?mc :movie-companies/movie, ?mk :movie-keyword/movie}}], :mpath [:free :movie-keyword/movie], :mcount 4523930, :free #:movie-keyword{:movie {:var ?t, :count 4523930}, :keyword {:var ?k, :count 4523930}}}}}, :plan {$ [(#datalevin.query.Plan{:steps ["Initialize [?t ?t.title] by range [[[:closed \"Kung Fu Panda\"] [:closed \"Kung Fu Panda����������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������\"]]] on :title/title." "Merge [?t.production-year] by scanning [:title/production-year]."], :cost 27, :size 1, :actual-size 8} #datalevin.query.Plan{:steps ["Merge ?mc by scanning reverse reference of :movie-companies/movie." "Merge [?cn] by scanning [:movie-companies/company]."], :cost 33, :size 3, :actual-size 36} #datalevin.query.Plan{:steps ["Initialize [?cn] by :company-name/name = DreamWorks Animation." "Merge [?bound40910] by scanning [:company-name/country-code]." "Hash join with the relation of #{?mc ?t}"], :cost 49, :size 1, :actual-size 4} #datalevin.query.Plan{:steps ["Merge ?mi by equal values of :movie-info/movie." "Merge [?mi.info ?it] by scanning [:movie-info/info :movie-info/info-type]."], :cost 63, :size 2, :actual-size 5} #datalevin.query.Plan{:steps ["Merge ?ci by equal values of :cast-info/movie." "Merge [?chn ?rt ?ci.note ?n] by scanning [:cast-info/person-role :cast-info/role :cast-info/note :cast-info/person]."], :cost 76, :size 1, :actual-size 122} #datalevin.query.Plan{:steps ["Merge [?n.name ?bound40909] by scanning [:name/name :name/gender]."], :cost 88, :size 1, :actual-size 5} #datalevin.query.Plan{:steps ["Filter by predicates on [:info-type/info]."], :cost 91, :size 1, :actual-size 5} #datalevin.query.Plan{:steps ["Filter by predicates on [:role-type/role]."], :cost 94, :size 1, :actual-size 5} #datalevin.query.Plan{:steps ["Merge [?chn.name] by scanning [:char-name/name]."], :cost 95, :size 1, :actual-size 5} #datalevin.query.Plan{:steps ["Merge ?mk by equal values of :movie-keyword/movie." "Merge [?k] by scanning [:movie-keyword/keyword]."], :cost 99, :size 2, :actual-size 162} #datalevin.query.Plan{:steps ["Merge ?an by equal values of :aka-name/person."], :cost 100, :size 1, :actual-size 810} #datalevin.query.Plan{:steps ["Merge [?k.keyword] by scanning [:keyword/keyword]."], :cost 103, :size 1, :actual-size 45})]}, :late-clauses (), :result (["Tigress" "Jolie, Angelina" "Kung Fu Panda 2"])}
