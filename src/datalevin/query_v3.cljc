(ns ^:no-doc datalevin.query-v3
  (:require
    ...
    [datalevin.parser :as dp #?@(:cljs [:refer [BindColl BindIgnore BindScalar BindTuple
...
(def query-cache (volatile! (datalevin.lru/lru lru-cache-size)))
...
(comment
  (t/test-ns 'datalevin.test.query-v3)
  ...
  (defn bench [name q & args]
    ...
    (perf/minibench (str "NEW " name) (apply datalevin.query-v3/q q args))
    nil)

   (do
    #_(require '[datalevin.query-v3 :as q] :reload)
