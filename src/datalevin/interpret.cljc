...
(defmacro inter-fn
  ...
  This function will be sent over the wire if the database is on a remote
  server or in a babashka pod. It runs in a sandboxed interpreter whether
  the database is remote or local.
