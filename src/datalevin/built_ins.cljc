...
(defn- less
  ([x] true)
  ([x y] (neg? ^long (d/compare-with-type x y)))
  ([x y & more]
   (if (less x y)
     (if (next more)
...
(defn- greater
  ([x] true)
  ([x y] (pos? ^long (d/compare-with-type x y)))
  ([x y & more]
   (if (greater x y)
     (if (next more)
       (recur y (first more) (next more))
...
(defn- less-equal
  ([x] true)
  ([x y] (not (pos? ^long (d/compare-with-type x y))))
  ([x y & more]
   (if (less-equal x y)
     (if (next more)
       (recur y (first more) (next more))
...
(defn- greater-equal
  ([x] true)
  ([x y] (not (neg? ^long (d/compare-with-type x y))))
  ([x y & more]
