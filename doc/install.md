...
```Clojure
{:deps {datalevin/datalevin {:mvn/version "0.7.9"}
...
* [Linux](https://github.com/juji-io/datalevin/releases/download/0.7.9/dtlv-0.7.9-ubuntu-latest-amd64.zip)
  on x86-64 (AMD64)
* [MacOS](https://github.com/juji-io/datalevin/releases/download/0.7.9/dtlv-0.7.9-macos-latest-amd64.zip)
  on x86-64 (AMD64)
* [Windows](https://github.com/juji-io/datalevin/releases/download/0.7.9/dtlv-0.7.9-windows-amd64.zip) on x86-64 (AMD64)

Unzip, put it on your path, and execute `dtlv help`:

```console
  Datalevin (version: 0.7.9)
...
A JVM
[uberjar](https://github.com/juji-io/datalevin/releases/download/0.7.9/datalevin-0.7.9-standalone.jar)
...
```console
java --add-opens=java.base/java.nio=ALL-UNNAMED --add-opens=java.base/sun.nio.ch=ALL-UNNAMED -jar datalevin-0.7.9-standalone.jar
```
This will start the Datalevin REPL.

```console
java --add-opens=java.base/java.nio=ALL-UNNAMED --add-opens=java.base/sun.nio.ch=ALL-UNNAMED -jar datalevin-0.7.9-standalone.jar serv -r /tmp/test-server
```
