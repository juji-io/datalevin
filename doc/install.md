...
* [Linux](https://github.com/juji-io/datalevin/releases/download/0.9.12/dtlv-0.9.12-ubuntu-latest-amd64.zip)
  on x86-64 (AMD64)
* [MacOS](https://github.com/juji-io/datalevin/releases/download/0.9.12/dtlv-0.9.12-macos-latest-aarch64.zip)
  on arm64 (AARCH64)
* [MacOS](https://github.com/juji-io/datalevin/releases/download/0.9.12/dtlv-0.9.12-macos-latest-amd64.zip)
  on x86-64 (AMD64)
* [Windows](https://github.com/juji-io/datalevin/releases/download/0.9.12/dtlv-0.9.12-windows-amd64.zip) on x86-64 (AMD64)
