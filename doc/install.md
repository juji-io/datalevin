...
```Clojure
{:deps {datalevin/datalevin {:mvn/version "0.8.1"}
...
* [Linux](https://github.com/juji-io/datalevin/releases/download/0.8.1/dtlv-0.8.1-ubuntu-latest-amd64.zip)
  on x86-64 (AMD64)
* [MacOS](https://github.com/juji-io/datalevin/releases/download/0.8.1/dtlv-0.8.1-macos-latest-aarch64.zip)
  on arm64 (AARCH64)
* [MacOS](https://github.com/juji-io/datalevin/releases/download/0.8.1/dtlv-0.8.1-macos-latest-amd64.zip)
  on x86-64 (AMD64)
* [Windows](https://github.com/juji-io/datalevin/releases/download/0.8.1/dtlv-0.8.1-windows-amd64.zip) on x86-64 (AMD64)
