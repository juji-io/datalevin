...
<a href="https://github.com/juji-io/datalevin/actions"><img src="https://github.com/juji-io/datalevin/actions/workflows/release.binaries.yml/badge.svg?branch=0.7.1" alt="datalevin linux/macos build status"></img></a>
...
* 0.7.1 Explicit transactions, lazy results loading, and results spill to disk
  when memory is low.
