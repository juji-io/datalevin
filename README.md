...
<a href="https://github.com/juji-io/datalevin/actions"><img src="https://github.com/juji-io/datalevin/actions/workflows/release.binaries.yml/badge.svg?branch=0.6.11" alt="datalevin linux/macos build status"></img></a>
...
```Clojure
{:deps {datalevin/datalevin {:mvn/version "0.6.11"}
...
* [Linux](https://github.com/juji-io/datalevin/releases/download/0.6.11/dtlv-0.6.11-ubuntu-latest-amd64.zip)
  on x86-64 (AMD64)
* [MacOS](https://github.com/juji-io/datalevin/releases/download/0.6.11/dtlv-0.6.11-macos-latest-amd64.zip)
  on x86-64 (AMD64)
* [Windows](https://github.com/juji-io/datalevin/releases/download/0.6.11/dtlv-0.6.11-windows-amd64.zip) on x86-64 (AMD64)

Unzip, put it on your path, and execute `dtlv help`:

```console
  Datalevin (version: 0.6.11)
...
A JVM
[uberjar](https://github.com/juji-io/datalevin/releases/download/0.6.11/datalevin-0.6.11-standalone.jar)
...
```console
java -jar datalevin-0.6.11-standalone.jar
```
