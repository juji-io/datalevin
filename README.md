...
src="https://github.com/juji-io/datalevin/actions/workflows/release.binaries.yml/badge.svg?branch=0.7.4"
...
* 0.7.4 Explicit transactions, lazy results loading, and results spill to disk
  when memory is low.
