...
<a href="https://github.com/juji-io/datalevin/actions"><img src="https://github.com/juji-io/datalevin/actions/workflows/release.binaries.yml/badge.svg?branch=0.5.0" alt="datalevin linux/macos build status"></img></a>
...
```Clojure
{:deps
 {datalevin/datalevin {:mvn/version "0.5.0"}}}
```
...
* [Linux](https://github.com/juji-io/datalevin/releases/download/0.5.0/dtlv-0.5.0-ubuntu-latest-amd64.zip)
* [MacOS](https://github.com/juji-io/datalevin/releases/download/0.5.0/dtlv-0.5.0-macos-latest-amd64.zip)
* [Windows](https://github.com/juji-io/datalevin/releases/download/0.5.0/dtlv-0.5.0-windows-amd64.zip)

Unzip, put it on your path, and execute `dtlv help`:

```console
  Datalevin (version: 0.5.0)
