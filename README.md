...
```Clojure
{:deps
 {datalevin/datalevin {:mvn/version "0.4.13"}}}
```
...
* [Linux](https://github.com/juji-io/datalevin/releases/download/0.4.13/dtlv-0.4.13-macos-latest-amd64.zip)
* [MacOS](https://github.com/juji-io/datalevin/releases/download/0.4.13/dtlv-0.4.13-macos-latest-amd64.zip)

Unzip, put it on your path, and execute `dtlv help`:

```console
  Datalevin (version: 0.4.13)
